    ...
    return (
        <div className="product-card group rounded-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 flex flex-col">
            ...
            <div className="p-4 flex flex-col gap-2 flex-1">
                <div>
                    {subcategory && (
                        <p className="text-xs text-neutral-500 mb-1">{category?.name} · {subcategory}</p>
                    )}
                    <Link to={`/producto/${_id}`}>
                        <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 line-clamp-2 leading-snug hover:text-neutral-900 dark:text-[#F5F5DC] transition-colors">
                            {name}
                        </h3>
                    </Link>
                </div>
                ...
                <div className="mt-auto">
                    <div className="flex items-baseline gap-2 flex-wrap">
                        <p className="font-mono font-bold text-neutral-900 dark:text-[#F5F5DC] text-lg leading-tight">
